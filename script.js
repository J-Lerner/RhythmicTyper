...
const sideBar = document.querySelector('#query-selector');
...
function ChangeSetting(fontFamily, fontSize) {
    if (fontFamily != "") {
        textInp.style.fontFamily = fontFamily + ", sans-serif";
        copyText.style.fontFamily = fontFamily + ", sans-serif";
    }
    if (fontSize != 0) {
        textInp.style.fontSize = (fontSize + "px").toString();
        copyText.style.fontSize = (fontSize + "px").toString();
    }
}
